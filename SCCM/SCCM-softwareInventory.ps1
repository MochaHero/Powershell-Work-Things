#Runs SCCM Client Actions on specified computers

$remotenames= "COMPUTER01"

Invoke-WmiMethod -ComputerName $remotenames -Namespace root\ccm -Class sms_client -name triggerschedule "{00000000-0000-0000-0000-000000000002}" -ErrorAction Continue
...
#    {00000000-0000-0000-0000-000000000102} Software Inventory Collection Cycle-- XX
